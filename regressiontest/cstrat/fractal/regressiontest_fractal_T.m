...
cd(path_);
bookname = 'govtbond_t_30m';
strategyname = 'fractal';
riskconfigfilename = 'config_govtbond_t_30m.txt';
...
combo = rtt_setup('countername','ccb_ly_fut',...
    ...
    'mode','replay',...
    'replayfromdate','2021-09-09','replaytodate','2021-09-09');
...
combo.strategy.load_kelly_intraday('directory',[getenv('onedrive'),'\fractal backtest\kelly distribution\matlab\govtbondfut\'],...
    'filename','strat_govtbondfut_30m.mat');
%%
combo.mdefut.start;
combo.ops.start;
