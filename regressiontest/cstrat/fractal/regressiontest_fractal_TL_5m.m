...
cd(path_);
bookname = 'govtbond_tl_5m';
strategyname = 'fractal';
riskconfigfilename = 'config_govtbond_tl_5m.txt';
...
modconfigfile([path_,riskconfigfilename],'code',codes{i},...
    ...
    'propvalues',{6;'5m';1;1;'spiderman';1;0});
end
%
combo = rtt_setup('countername','ccb_ly_fut',...
    ...
    'mode','replay',...
    'replayfromdate','2024-01-05','replaytodate','2024-01-05');
combo.strategy.displaysignalonly_ = false;
combo.mdefut.printflag_ = true;combo.mdefut.print_timeinterval_ =  5*60;
...
combo.strategy.load_kelly_intraday('directory',[getenv('onedrive'),'\fractal backtest\kelly distribution\matlab\govtbondfut\'],...
    'filename','strat_govtbondfut_5m.mat');
