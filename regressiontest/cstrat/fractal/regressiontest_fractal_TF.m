...
cd(path_);
bookname = 'govtbond_tf';
strategyname = 'fractal';
riskconfigfilename = 'config_govtbond_tf.txt';
...
combo = rtt_setup('countername','ccb_ly_fut',...
    ...
    'mode','replay',...
<<<<<<< Updated upstream
    'replayfromdate','2022-10-28','replaytodate','2022-10-28');
=======
    'replayfromdate','2022-11-02','replaytodate','2022-11-02');
>>>>>>> Stashed changes
