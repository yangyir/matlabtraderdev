...
riskconfigfilename = 'daily_config_pb.txt';
...
combo = rtt_setup('countername','ccb_ly_fut',...
    ...
    'mode','replay',...
    'replayfromdate','2023-08-23','replaytodate','2023-09-01');
...
combo.strategy.load_kelly_daily('Directory',[getenv('onedrive'),'\fractal backtest\kelly distribution\matlab\comdty_domestic\'],...
