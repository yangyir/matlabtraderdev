...
trade1 = cTradeOpen('code',code1,'opendatetime',datenum('2018-08-03 09:00:01'),'openvolume',1,'openprice',11090,'opendirection',1);trade1.status_ = 'set';
trade1.setsignalinfo('name','williamsr','extrainfo',extrainfo1);trade1.setriskmanager('name','batman','extrainfo',batman_extrainfo);
trades.push(trade1);
trade2 = cTradeOpen('code',code1,'opendatetime',datenum('2018-08-03 09:00:02'),'openvolume',1,'openprice',11070,'opendirection',1);trade2.status_ = 'set';
trade2.setsignalinfo('name','williamsr','extrainfo',extrainfo1);trade2.setriskmanager('name','batman','extrainfo',batman_extrainfo);
trades.push(trade2);
trade3 = cTradeOpen('code',code1,'opendatetime',datenum('2018-08-03 09:00:03'),'openvolume',1,'openprice',11040,'opendirection',1);trade3.status_ = 'set';
trade3.setsignalinfo('name','williamsr','extrainfo',extrainfo1);trade3.setriskmanager('name','batman','extrainfo',batman_extrainfo);
trades.push(trade3);
trade4 = cTradeOpen('code',code1,'opendatetime',datenum('2018-08-03 09:00:04'),'openvolume',1,'openprice',11000,'opendirection',1);trade4.status_ = 'set';
trade4.setsignalinfo('name','williamsr','extrainfo',extrainfo1);trade4.setriskmanager('name','batman','extrainfo',batman_extrainfo);
trades.push(trade4);
trade5 = cTradeOpen('code',code1,'opendatetime',datenum('2018-08-03 09:00:05'),'openvolume',1,'openprice',10090,'opendirection',1);trade5.status_ = 'set';
...
trade6 = cTradeOpen('code',code2,'opendatetime',datenum('2018-08-03 09:00:11'),'openvolume',1,'openprice',4081,'opendirection',-1);trade6.status_ = 'set';
trade6.setsignalinfo('name','williamsr','extrainfo',extrainfo2);trade6.setriskmanager('name','batman','extrainfo',batman_extrainfo);
trades.push(trade6);
trade7 = cTradeOpen('code',code2,'opendatetime',datenum('2018-08-03 09:00:12'),'openvolume',1,'openprice',4082,'opendirection',-1);trade7.status_ = 'set';
trade7.setsignalinfo('name','williamsr','extrainfo',extrainfo2);trade7.setriskmanager('name','batman','extrainfo',batman_extrainfo);
trades.push(trade7);
trade8 = cTradeOpen('code',code2,'opendatetime',datenum('2018-08-03 09:00:13'),'openvolume',1,'openprice',4083,'opendirection',-1);trade8.status_ = 'set';
trade8.setsignalinfo('name','williamsr','extrainfo',extrainfo2);trade8.setriskmanager('name','batman','extrainfo',batman_extrainfo);
trades.push(trade8);
trade9 = cTradeOpen('code',code2,'opendatetime',datenum('2018-08-03 09:00:14'),'openvolume',1,'openprice',4084,'opendirection',-1);trade9.status_ = 'set';
trade9.setsignalinfo('name','williamsr','extrainfo',extrainfo2);trade9.setriskmanager('name','batman','extrainfo',batman_extrainfo);
trades.push(trade9);
trade10 = cTradeOpen('code',code2,'opendatetime',datenum('2018-08-03 09:00:15'),'openvolume',1,'openprice',4085,'opendirection',-1);trade10.status_ = 'set';
