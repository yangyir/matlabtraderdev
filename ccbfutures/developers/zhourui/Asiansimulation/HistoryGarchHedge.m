...
GarVol=HisVol(cell2mat(ExerciseData(:,2)),cell2mat(ExerciseData(:,3)),ExerciseTimes,Times);
...
for i=1:1:kk
    ...
    Parameter.Vol=GarVol(i);
    [TotalPnl,UnderlyingPnl,OptionPnl,FeePnl,Delta,UnderlyingPath,TradingDay ,perPnl,strikePath,averagePath,VegaCashPath]=HisSimGarch(Parameter,Times,cell2mat(UnderlyingData(:,3)),GarVol);
