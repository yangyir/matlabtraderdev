function [ TPnl,UPnl,OPnl,FPnl,Delta,UnderlyingPath,TradingDay ,perPnl,StrikePath,AveragePath,VegaPath] = HisSimGarch( Parameter,TradingDay,UnderlyingPath,GarchVol )
    ...
    for i=1:1:length(TradingDay);
        if (AverageDay(1)-TradingDay(i)>0)
            ...
            Vol=GarchVol(i);
            OptionPrice(i)=AsianCurran(Parameter.cp,UnderlyingPath(i),Average,Parameter.Strike,t1,T,n,m,Parameter.RiskFreeRate,Parameter.CostOfCarry,Vol);
            delta(i)=AsianGreeks('delta',Parameter.cp,UnderlyingPath(i),Average,Parameter.Strike,t1,T,n,m,Parameter.RiskFreeRate,Parameter.CostOfCarry,Vol);
            gamma(i)=AsianGreeks('gamma',Parameter.cp,UnderlyingPath(i),Average,Parameter.Strike,t1,T,n,m,Parameter.RiskFreeRate,Parameter.CostOfCarry,Vol);
            VegaPath(i)=AsianGreeks('vega',Parameter.cp,UnderlyingPath(i),Average,Parameter.Strike,t1,T,n,m,Parameter.RiskFreeRate,Parameter.CostOfCarry,Vol);
