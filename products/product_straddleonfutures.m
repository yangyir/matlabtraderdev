function product = product_straddleonfutures(varargin)
    %
    % function to return the product of a straddle on a futures
    % straddle:holding a position in both a call and put with the same
