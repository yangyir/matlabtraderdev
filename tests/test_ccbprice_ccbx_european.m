...
%
mdlX = CreateObj('ccbx','model','modelname','ccbx',...
    'numberofsims',1000,'numberofruns',100,'usebusinesscalendar',true);
%
lv = CreateObj('goldvol','vol','volname','localvol','voltype','FlatVol',...
    'assetname',assetname,'flatvol',0.12);
