...
for i = 1:textboxCount
    ...
    if strcmpi(textboxNames{i},'StartDate') || strcmpi(textboxNames{i},'EndDate')
        ...
        handles.generalsetup.(editboxname) = uicontrol('Parent', panelbox, 'style', 'edit', ...
            'Backgroundcolor', boxBackGroundColor, 'Foregroundcolor', 'b', 'String', {datestr(getlastbusinessdate,'yyyy-mm-dd')}, ...
            'Units', 'Normalized',...
...
%todo:here the active futures file is hard code and shall be revised
activefuts = cDataFileIO.loadDataFromTxtFile(['c:\yangyiran\activefutures\activefutures_',datestr(getlastbusinessdate,'yyyymmdd'),'.txt']);
...
for i = 1:nButtons  
    ...
    handles.mktdataops.mdefutInitButton   = uicontrol('Parent', panelbox, 'style', 'pushbutton', ...
