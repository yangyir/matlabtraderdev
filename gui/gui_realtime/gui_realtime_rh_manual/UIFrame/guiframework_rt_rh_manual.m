function handles = guiframework_rt_rh_manual
%%
...
set(handles.output, 'Name', 'Rohan Realtime Manual Trading Framework', 'NumberTitle', 'off');
...
textboxNames = {'CounterName';'StrategyName';'RiskConfig';'StartupFund';'MktDataDir';'TradesDir'};
...
for i = 1:textboxCount
    ...
    if strcmpi(textboxNames{i},'MktDataDir') || ...
            ...
            strcmpi(textboxNames{i},'StrategyName')
        if strcmpi(textboxNames{i},'MktDataDir')
        ...
        elseif strcmpi(textboxNames{i},'StrategyName')
            editstr = 'manual';
        end
    ...
    if strcmpi(textboxNames{i},'CounterName')
        ...
        handles.generalsetup.(popupmenuname) = uicontrol('Parent', panelbox, 'style', 'popupmenu', ...
            'Backgroundcolor', boxBackGroundColor, 'Foregroundcolor', 'b', 'String', {'rh_demo','rh_demo_tf'}, ...
