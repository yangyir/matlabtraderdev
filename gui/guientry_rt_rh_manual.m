function [ handles,mdefut,strat,ops ] = guientry_rt_rh_manual
    %
    global MDEFUT_INSTANCE;
    global STRAT_INSTANCE;
    global OPS_INSTANCE;
    
    handles = guiframework_rt_rh_manual;
    ...
    %
    ops = cOps('Name','tfzq_ops_rh_manual');
...
%     STRAT_INSTANCE.registerhelper(OPS_INSTANCE);
    ...
    set(handles.mktdataops.mdefutInitButton,'CallBack',{@guicallback_rt_rh_mdefutinitbutton, handles});
