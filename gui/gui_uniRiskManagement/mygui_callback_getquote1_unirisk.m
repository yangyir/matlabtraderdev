...
optmargin_o32=0;
     ...
     quote_data{9,1} = (1-quote_data{3,1}-quote_data{7,1})*100;
     ...
     quote_data{6,2} = 0;
     quote_data{7,2} = 0;
     quote_data{9,2} = (1-quote_data{3,2}-quote_data{7,2})*100;
    ...
    if quote_data{7,3} <= quote_data_warning{1,3}
     ...
     if quote_data{7,4} <= quote_data_warning{1,4}
         quote_data_warning{4,3} = '     正常';
     else
         quote_data_warning{4,3} = '   超出限额';
     end
