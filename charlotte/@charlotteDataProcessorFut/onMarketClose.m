...
%     end
    ...
    if strcmpi(obj.mode_,'replay')
        data = struct('code',obj.codes_{1},...
            'datetime',obj.candles_m1_{1}(end,1),...
            'open',obj.candles_m1_{1}(end,2),...
            'high',obj.candles_m1_{1}(end,3),...
            'low',obj.candles_m1_{1}(end,4),...
            'close',obj.candles_m1_{1}(end,5));
        notify(obj, 'NewBarSetM1', charlotteDataFeedEventData(data));
        %
        data = struct('code',obj.codes_{1},...
            'datetime',obj.candles_m5_{1}(end,1),...
            'open',obj.candles_m5_{1}(end,2),...
            'high',obj.candles_m5_{1}(end,3),...
            'low',obj.candles_m5_{1}(end,4),...
            'close',obj.candles_m5_{1}(end,5));
        notify(obj, 'NewBarSetM5', charlotteDataFeedEventData(data));
        %
        data = struct('code',obj.codes_{1},...
            'datetime',obj.candles_m15_{1}(end,1),...
            'open',obj.candles_m15_{1}(end,2),...
            'high',obj.candles_m15_{1}(end,3),...
            'low',obj.candles_m15_{1}(end,4),...
            'close',obj.candles_m15_{1}(end,5));
        notify(obj, 'NewBarSetM15', charlotteDataFeedEventData(data));
        %
        data = struct('code',obj.codes_{1},...
            'datetime',obj.candles_m30_{1}(end,1),...
            'open',obj.candles_m30_{1}(end,2),...
            'high',obj.candles_m30_{1}(end,3),...
            'low',obj.candles_m30_{1}(end,4),...
            'close',obj.candles_m30_{1}(end,5));
