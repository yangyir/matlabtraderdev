...
if isfx(codein) || strcmpi(codein,'UK100') || strcmpi(codein,'AUS200') || strcmpi(codein,'J225') || ...
        ...
        strcmpi(codein,'AD') || strcmpi(codein,'EC') || strcmpi(codein,'BP') || ...
        strcmpi(codein,'CD') || strcmpi(codein,'SF') || strcmpi(codein,'JY') || ...
        strcmpi(codein,'NE') || strcmpi(codein,'GC') || strcmpi(codein,'SI') || ...
        strcmpi(codein,'NQ') || strcmpi(codein,'ES')
...
if isfx(fut.asset_name)
    plotshift = 2*fut.tick_size;
elseif strcmpi(codein,'AD') || strcmpi(codein,'EC') || strcmpi(codein,'BP') || ...
        strcmpi(codein,'CD') || strcmpi(codein,'SF') || strcmpi(codein,'JY') || ...
        strcmpi(codein,'NE') || strcmpi(codein,'GC') || strcmpi(codein,'SI') || ...
        strcmpi(codein,'NQ') || strcmpi(codein,'ES')
    plotshift = 2*fut.tick_size;
