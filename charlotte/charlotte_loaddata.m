...
elseif strcmpi(freq,'15m')
    ...
    elseif strcmpi(futcode,'AD') || strcmpi(futcode,'EC') || strcmpi(futcode,'BP') || ...
            strcmpi(futcode,'CD') || strcmpi(futcode,'SF') || strcmpi(futcode,'JY') || ...
            strcmpi(futcode,'NE') || strcmpi(futcode,'GC') || strcmpi(futcode,'SI') || ...
            strcmpi(futcode,'NQ') || strcmpi(futcode,'ES')
        data = load([getenv('onedrive'),'\mt5\futuresfx\',futcode,'_MT5_M15.mat']);
    else
    end
    p = data.data;
elseif strcmpi(freq,'30m')
    ...
    elseif strcmpi(futcode,'AD') || strcmpi(futcode,'EC') || strcmpi(futcode,'BP') || ...
            ...
            strcmpi(futcode,'NE') || strcmpi(futcode,'GC') || strcmpi(futcode,'SI') || ...
            strcmpi(futcode,'NQ') || strcmpi(futcode,'ES')
        data = load([getenv('onedrive'),'\mt5\futuresfx\',futcode,'_MT5_M30.mat']);
    else
...
elseif strcmpi(freq,'60m') || strcmpi(freq,'1h')
    ...
    if ~(isfx(futcode) || strcmpi(futcode,'UK100') || strcmpi(futcode,'AUS200') || strcmpi(futcode,'J225') || ...
            ...
            strcmpi(futcode,'AD') || strcmpi(futcode,'EC') || strcmpi(futcode,'BP') || ...
            strcmpi(futcode,'CD') || strcmpi(futcode,'SF') || strcmpi(futcode,'JY') || ...
            strcmpi(futcode,'NE') || strcmpi(futcode,'GC') || strcmpi(futcode,'SI') || ...
            strcmpi(futcode,'NQ') || strcmpi(futcode,'ES'))
        error('charlotte_loaddata:intraday data load failure,pls check!!!')
    end
    if strcmpi(futcode,'AD') || strcmpi(futcode,'EC') || strcmpi(futcode,'BP') || ...
            strcmpi(futcode,'CD') || strcmpi(futcode,'SF') || strcmpi(futcode,'JY') || ...
            strcmpi(futcode,'NE') || strcmpi(futcode,'GC') || strcmpi(futcode,'SI') || ...
            strcmpi(futcode,'NQ') || strcmpi(futcode,'ES')
        data = load([getenv('onedrive'),'\mt5\futuresfx\',futcode,'_MT5_H1.mat']);
        p = data.data;
    else
        if ~useMT5
...
elseif strcmpi(freq,'240m') || strcmpi(freq,'4h')
    ...
    if strcmpi(futcode,'AD') || strcmpi(futcode,'EC') || strcmpi(futcode,'BP') || ...
            ...
            strcmpi(futcode,'NE') || strcmpi(futcode,'GC') || strcmpi(futcode,'SI') || ...
            strcmpi(futcode,'NQ') || strcmpi(futcode,'ES')
        data = load([getenv('onedrive'),'\mt5\futuresfx\',futcode,'_MT5_H4.mat']);
        p = data.data;
    else
        if ~useMT5
