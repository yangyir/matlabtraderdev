...
%     end
    ...
    breachupfailed = ~(ei.p(end,5)-ei.hh(end-1)-ticksizeratio*trade.instrument_.tick_size >= -1e-6) & ...
        ei.p(end,3)-ei.hh(end-1)-ticksizeratio*trade.instrument_.tick_size >= -1e-6;
    %
    breachupsuccess = ei.p(end,5)-ei.hh(end-1)-ticksizeratio*trade.instrument_.tick_size >= -1e-6 & ...
        ei.p(end-1,5) < ei.hh(end-1);
    %
    breachdnfailed = ~(ei.p(end,5)-ei.ll(end-1)+ticksizeratio*trade.instrument_.tick_size <= 1e-6) &...
