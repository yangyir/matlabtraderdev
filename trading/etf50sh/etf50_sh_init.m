...
opt50_c_jan = cell(length(k_50),1);opt50_p_jan = opt50_c_jan;
...
%     opt50_p_nov{i} = ['510050 CH ',datestr(exp_nov,'mm/dd/yy'),' P',num2str(k_50(i)),' Equity'];
    ...
    opt50_c_jan{i} = ['510050 CH ',datestr(exp_jan,'mm/dd/yy'),' C',num2str(k_50(i)),' Equity'];
    opt50_p_jan{i} = ['510050 CH ',datestr(exp_jan,'mm/dd/yy'),' P',num2str(k_50(i)),' Equity'];
end
%%
db = cLocal;
%%
...
%%
opt50_c_1 = opt50_c_jan;
opt50_p_1 = opt50_c_jan;
