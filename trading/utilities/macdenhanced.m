...
outputs = struct('k1',k1,'y1',y1,...
    ...
    'k3',k3,'y3',y3,...
    'k4',k4,'y4',y4,...
    'range1max',range1max,'range1min',range1min,'range1close',range1close,...
    'range1maxbarsize',range1maxbarsize,'range1minbarsize',range1minbarsize,...
    'range2max',range2max,'range2min',range2min,'range2close',range2close,...
    'range2maxbarsize',range2maxbarsize,'range2minbarsize',range2minbarsize,...
    'range3max',range3max,'range3min',range3min,'range3close',range3close,...
    'range3maxbarsize',range3maxbarsize,'range3minbarsize',range3minbarsize,...
    'x',x,...
    'xreal',xreal,...
    'lbrunning',lb_running,...
    'ubrunning',ub_running,...
    'lbcritical',lb_critical,...
    'ubcritical',ub_critical);
