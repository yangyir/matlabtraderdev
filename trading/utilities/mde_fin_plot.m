...
for i = 1:n
      ...
      if size(op_i,1) >= 80
          tools_technicalplot2(op_i(end-79:end,:),n_fin+1,[instruments{i}.code_ctp,'-',num2str(mdefut.candle_freq_(i)),'m'],true);
      else
          tools_technicalplot2(op_i(1:end,:),n_fin+1,[instruments{i}.code_ctp,'-',num2str(mdefut.candle_freq_(i)),'m'],true);
      end
end
