...
%return conditional signal given kelly distribution tables
    ...
    if ~isempty(signal) && ~isempty(signal{1,1}) && signal{1,1}(1) == 1
        ...
        if highs(1) == highest && highest > ei.hh(end) && (nfractal ~= 6 || ...
                nfractal == 6 && ei.sc(end-nfractal+1) == 13)
            signal{1,1}(2) = highest;
%             output = {};
%             return
        end
        %
            ...
            if isbreachuplvlup
                ...
                if kelly >= 0.088 && wprob >= 0.3
                    ...
                    isclose2lvlup = ~isnan(ei.lvlup(end)) && ~isnan(ei.lvldn(end)) && ...
                        ...
                        ((ei.lvlup(end)-signal{1,1}(2) <= 4*ticksize && nfractal > 2) || ...
                        ((ei.lvlup(end)-signal{1,1}(2))/signal{1,1}(2) <= 0.003 && nfractal < 6));
            ...
            if isbreachdnlvldn
                ...
                if kelly >= 0.088 && wprob >= 0.3
                    ...
                    isclose2lvldn = ~isnan(ei.lvlup(end)) && ~isnan(ei.lvldn(end)) && ...
                        ...
                        ((signal{1,2}(3)-ei.lvldn(end) <= 4*ticksize && nfractal > 2) || ...
                        ((signal{1,2}(3)-ei.lvldn(end))/signal{1,2}(3) <= 0.003 && nfractal < 6));
