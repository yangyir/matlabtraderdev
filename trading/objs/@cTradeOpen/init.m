...
if isempty(obj.instrument_)
    ...
    elseif isfx(obj.instrument_.asset_name) || strcmpi(obj.code_,'brent') || strcmpi(obj.code_,'wti') || ...
            strcmpi(obj.code_,'UK100') || strcmpi(obj.code_,'AUS200') || strcmpi(obj.code_,'J225') || ...
                    ...
                    strcmpi(obj.code_,'NASDAQ') || strcmpi(obj.code_,'SPX500') || ...
                    strcmpi(obj.code_,'AD') || strcmpi(obj.code_,'EC') || strcmpi(obj.code_,'BP') || ...
                    strcmpi(obj.code_,'CD') || strcmpi(obj.code_,'SF') || strcmpi(obj.code_,'JY') || ...
                    strcmpi(obj.code_,'NE') || strcmpi(obj.code_,'GC') || strcmpi(obj.code_,'SI') || ...
                    strcmpi(obj.code_,'NQ') || strcmpi(obj.code_,'ES')
