...
qms_fut_govtbond.registerinstrument(bnd_5y);
qms_fut_govtbond.registerinstrument(bnd_10y);
qms_fut_govtbond.refresh;
q_5y = qms_fut_govtbond.getquote(bnd_5y);
q_10y = qms_fut_govtbond.getquote(bnd_10y);
