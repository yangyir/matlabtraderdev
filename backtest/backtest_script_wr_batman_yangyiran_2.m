...
fprintf('%s trade open at %s; close at %s; close pnl:%s...\n',dirstr,num2str(tradeOpen.openprice_),num2str(tradeOpen.closeprice_),num2str(tradeOpen.closepnl_));
