...
parfor i = 1:size(codes_fx,1)
    ...
    [~,~,tbl2check_fx_m15{i}] = charlotte_backtest_period('code',codes_fx{i},'fromdate',dt1,'todate',dt2,'kellytables',strat_fx_m15,'showlogs',false,'doplot',false,'frequency',freq_m15,'nfractal',nfractal_m15,'compulsorycheckforconditional',true);
end
