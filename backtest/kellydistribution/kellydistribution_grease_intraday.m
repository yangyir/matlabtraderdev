...
strat_intraday_grease = struct('tblbyasset_l',tblbyasset_l_grease_i,...
    ...
    'breachuplvlup_tc',tb_grease_i{5}.table,...
    'breachdnlvldn_tc',tb_grease_i{6}.table,...
    'breachupsshighvalue_tc',tb_grease_i{7}.table,...
    'breachdnbshighvalue_tc',tb_grease_i{8}.table,...
    'breachuphighsc13',tb_grease_i{9}.table,...
    'breachdnlowbc13',tb_grease_i{10}.table,...
