...
%
%%
strat_intraday_grease = struct('tblbyasset_l',tblbyasset_l_grease_i,...
    'tblbyasset_s',tblbyasset_s_grease_i,...
    'kelly_table_l',k_l_grease_i,...
    'kelly_table_s',k_s_grease_i,...
    ...
    'breachuplvlup_tc',tc_grease_i{5}.table,...
    'breachdnlvldn_tc',tc_grease_i{6}.table,...
    'breachupsshighvalue_tc',tc_grease_i{7}.table,...
    'breachdnbshighvalue_tc',tc_grease_i{8}.table,...
    'breachuphighsc13',tc_grease_i{9}.table,...
    'breachdnlowbc13',tc_grease_i{10}.table,...
    'kelly_matrix_l',KMat_L_grease_i,...
    'kelly_matrix_s',KMat_S_grease_i,...
    'winprob_matrix_l',WMat_L_grease_i,...
    'winprob_matrix_s',WMat_S_grease_i,...
