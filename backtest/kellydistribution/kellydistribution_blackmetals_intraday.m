...
strat_intraday_blackmetal = struct('tblbyasset_l',tblbyasset_l_blackmetal_i,...
    ...
    'breachuplvlup_tc',tc_blackmetal_i{5}.table,...
    'breachdnlvldn_tc',tc_blackmetal_i{6}.table,...
    'breachupsshighvalue_tc',tc_blackmetal_i{7}.table,...
    'breachdnbshighvalue_tc',tc_blackmetal_i{8}.table,...
    'breachuphighsc13',tc_blackmetal_i{9}.table,...
    'breachdnlowbc13',tc_blackmetal_i{10}.table,...
