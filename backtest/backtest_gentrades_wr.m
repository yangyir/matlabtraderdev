    ...
    for i = idx_start:idx_end
        ...
        if pxHigh > pxMax && pxLow >= pxMin
            ...
            trade_i = cTradeOpen('code',code,...
                ...
                'openvolume',1,...
                'openprice',pxMax,...
                'targetprice',pxMax-round(target_ratio*(pxMax-pxMin)/tick_size)*tick_size,...
                'stoplossprice',pxMax+round(stoploss_ratio*(pxMax-pxMin)/tick_size)*tick_size,...
                'stoptime',gettradestoptime(code,datetime,freq_,stopperiod_),...
        ...
        elseif pxHigh > pxMax && pxLow < pxMin
            ...
            trade_i = cTradeOpen('code',code,...
                ...
                'openvolume',1,...
                'openprice',pxMin,...
                'targetprice',pxMin+round(target_ratio*(pxMax-pxMin)/tick_size)*tick_size,...
                'stoplossprice',pxMin-round(stoploss_ratio*(pxMax-pxMin)/tick_size)*tick_size,...
                'stoptime',gettradestoptime(code,datetime,freq_,stopperiod_),...
                'riskmanagementmethod','standard');
            trades.push(trade_i);
        elseif pxHigh <= pxMax && pxLow >= pxMin
