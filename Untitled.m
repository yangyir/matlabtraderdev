...
%%
%1m candle data
%we take 14 calendar day data before the roll date of the 2nd contract
candle_1m = cell(n,1);
for i = 1:n
    if i == 1
        ...
        startdt = [datestr(rolldts(i-1)-14,'yyyy-mm-dd'),' 09:00:00'];
        if i == n
...
for i = 1:n
    candle_1m{i} = timeseries_window(candle_1m{i},'tradinghours',futs{i}.trading_hours,'tradingbreak',futs{i}.trading_break);
end
%%
